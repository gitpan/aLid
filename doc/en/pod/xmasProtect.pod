...
B<xmasProtect - Script used for intercept attempts of port scanning by Xmas scan.>

=head1 SYNOPSIS

B<xmasProtect RANGE EVT_BOUND RED_BOUND FILE_IP_BLOCKED NOTIFY FILTER [FREQ_EMAIL] >
